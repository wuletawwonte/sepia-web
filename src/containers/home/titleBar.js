...
import {
  Nav, NavBar, NavBrand, NavCollapsible, NavDropdown, NavDropdownLink, NavDropdownMenu,
  NavDropdownMenuHeader, NavDropdownMenuItem, NavLink, NavLinks, NavToggler,
...
export function TitleBarLink(props) {
  const {
    className, title, icon, ...otherProps
  } = props;
  return (
    <NavLink
      {...otherProps}
