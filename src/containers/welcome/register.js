...
import {
  Form, FormRow, FormGroup, FormLabel,
} from '../../components/form.js';
import { SelectDate, SelectMonthByName, SelectYear } from '../../components/dates.js';
import {
  Genders, GenderInput, Qualifications, QualificationInput,
            ...
            <div className="border rounded py-2 px-1 w-100">
              <div className="custom-control custom-radio">
                <input
                  ...
                  onChange={handleChange}
                />
                <label htmlFor="registerInput10" className="custom-control-label w-100">
                  Yes
                </label>
              </div>
            </div>
            ...
            <div className="border rounded py-2 px-1 w-100">
              <div className="custom-control custom-radio">
                <input
                  ...
                  onChange={handleChange}
                />
                <label htmlFor="registerInput11" className="custom-control-label w-100">
                  No
                </label>
              </div>
            </div>
