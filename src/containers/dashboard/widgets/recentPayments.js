...
import {
  TitleBar, Widget, WidgetBody, WidgetList, WidgetListItem,
        ...
        <Row>
          <Col className="align-self-center">
            <Row>
              <Col>
                <Link
                  to={`/appointments/${props.payment.appointmentId}/payments`}
  ...
  useEffect(() => {
    async function initialize() {
      try {
        ...
        const response = await fetch(`https://gp-medicus.herokuapp.com/api/users/${username}/payments?page=${page}&limit=${state.limit}`, {
          headers: {
