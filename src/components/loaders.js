                ...
                <FluidContainer className="p-3">
                  <Row className="justify-content-center">
                    <Col className="col-auto align-self-center">
                      <Row>
                        <div id="ellipsis01" className="md-ellipsis mx-1" />
                        <div id="ellipsis02" className="md-ellipsis mx-1" />
                        <div id="ellipsis03" className="md-ellipsis mx-1" />
                      </Row>
                    </Col>
                  </Row>
                </FluidContainer>
